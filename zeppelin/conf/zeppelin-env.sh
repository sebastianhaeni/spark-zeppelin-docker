...
export SPARK_SUBMIT_OPTIONS="--conf spark.jars.ivo=/tmp/.ivy --deploy-mode cluster --master spark://spark-master:7077"                   # (optional) extra options to pass to spark submit. eg) "--driver-memory 512M --executor-memory 1G".
